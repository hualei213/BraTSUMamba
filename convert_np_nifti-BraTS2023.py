...
if __name__ == '__main__':
    ...
    for test_id in test_list:
        ...
        raw_nifty_file_t2w = os.path.join(raw_top_folder, test_id,
                                          test_id + '-t2w.nii.gz')
        raw_brain_mask_file = os.path.join(raw_top_folder, test_id,
                                          test_id + '-seg.nii.gz')
        ...
        # copy files
        shutil.copy2(raw_nifty_file_t1n, pre_folder)
        shutil.copy2(raw_nifty_file_t1c, pre_folder)
        shutil.copy2(raw_nifty_file_t2f, pre_folder)
        shutil.copy2(raw_nifty_file_t2w, pre_folder)
