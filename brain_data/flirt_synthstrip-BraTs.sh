data_path="/mnt/HDLV1/YHR/dataset_2/BraTS2023/BraTS-GLI/TrainingData_resize_182"
output_path="/mnt/HDLV1/YHR/dataset_2/BraTS2023/BraTS-GLI/TrainingData_resize_182_flirt"
...
brain_registration_dir=${output_path}"/brain_registration/"
...
#  echo $file_name_current_case_without_extension
  ...
  path_to_MNI_mask="${brain_registration_dir}/${file_name_current_case_without_extension//image/mask}.nii.gz"
  # get brain file path
  path_to_current_t1_case2="${data_path}/${small_data_name}/${file_name_current_case_without_extension//image/mask}.nii.gz"
  echo "Registering scan: "${path_to_current_t1_case2}
  ...
  basic_filename="$brain_registration_dir${file_name_current_case_without_extension//image/mask}" #文件路径
