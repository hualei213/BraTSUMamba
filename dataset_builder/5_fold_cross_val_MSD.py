...
for fold in folders:
    ...
    # fold = '/mnt/HDLV1/YHR/brain_tumor/TaskO1_BrainTumour/imagesTr/.BRATS_351'
    fold = fold.rsplit('.nii.gz', 1)[0]
    # 使用os.path.splitext移除扩展名
    # fold = os.path.splitext(fold)[0]
    # 使用os.path.basename获取不带路径的文件名
    fold = os.path.basename(fold)
