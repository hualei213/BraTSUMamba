...
class PrototypeArchitecture3d(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
        ...
        ######################### Encoder:
        # Level 1
        self.conv_enc_1_1 = Conv3dNormAct(n_channels, 30, kernel_size=3, padding=1)
        ...
        self.conv_pathD = nn.Conv3d(45, 2, kernel_size=1)
    ...
    def forward(self, x_1):
        ...
        out = torch.cat((x_pathA,x_pathB,x_pathC),1)
        out = self.conv_pathD(out)
        return out
        # Classification
