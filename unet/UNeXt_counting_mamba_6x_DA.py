...
class UNeXt_counting_mamba_6x_DA(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(UNeXt_counting_mamba_6x_DA, self).__init__()
        ...
        self.cbam4 = DA_Block(128)
        self.cbam3 = DA_Block(64)
        self.cbam2 = DA_Block(32)
        self.cbam1 = DA_Block(16)
...
if __name__ == "__main__":
    ...
    model = UNeXt_counting_mamba_6x_DA(n_channels=4, n_classes=4)
    model = model.cuda()
