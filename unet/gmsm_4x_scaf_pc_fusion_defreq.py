...
class gmsm_4x_scaf_pc_fusion_defreq(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(gmsm_4x_scaf_pc_fusion_defreq, self).__init__()
