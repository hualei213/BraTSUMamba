...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        # padding
        pad_input = (H % 2 == 1) or (W % 2 == 1) or (W % 2 ==1)
        if pad_input:
...
class PatchEmbed3D(nn.Module):
    ...
    def __init__(self, img_size=(128, 128, 128), patch_size=(2, 2, 2), in_chans=3, embed_dim=24, norm_layer=None):
        super().__init__()
        self.patch_size = patch_size
...
class SwinTransformerSys3D(nn.Module):
    ...
    def __init__(self, pretrained=None,
        ...
        print(
            "SwinTransformerSys3D expand initial----depths:{};drop_path_rate:{};embed_dims:{};window:{}".format(
                depths, drop_path_rate, embed_dim, window_size))
