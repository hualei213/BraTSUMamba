...
from myfile.GAB import GroupAggregationBridge3D
...
class UNeXt_3D_mlp_attention_seg_counting_MSBMamba_GAB(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(UNeXt_3D_mlp_attention_seg_counting_MSBMamba_GAB, self).__init__()
        ...
        self.gab4 = GroupAggregationBridge3D(256, 128)
        self.gab3 = GroupAggregationBridge3D(128, 64)
        self.gab2 = GroupAggregationBridge3D(64, 32)
        self.gab1 = GroupAggregationBridge3D(32, 16)
