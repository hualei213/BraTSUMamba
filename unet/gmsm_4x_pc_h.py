...
def laplacian_pyramid_3d_low(image, levels=1):
    current = image
    pyramid = []
    for _ in range(levels):
        blurred = gaussian_blur_3d(current, sigma=1.0)
...
class gmsm_4x_pc_h(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(gmsm_4x_pc_h, self).__init__()
    ...
    def forward_decoder(self,out,t1,t2,t3,t4):
        ...
        out = out + self.MDAF4(out,high_f4)
        #######################################################
        # up 2
        out = F.relu6(
        ...
        out = out + self.MDAF3(out, high_f3)
        ...
        out = out + self.MDAF2(out, high_f2)
        ...
        # out = out + self.MDAF1(out, high_f1)
        ...
        # high_f0 = laplacian_pyramid_3d(out, 1)
        # high_f0 = self.conv_fre111_0(high_f0)
        # # out = high_f0
        # out = out + self.MDAF0(out, high_f0)
