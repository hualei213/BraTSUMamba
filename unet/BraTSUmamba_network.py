...
#Bi-granularity Mamba
class MambaEncoder(nn.Module):
    def __init__(self, in_chans=4, depths=[2, 2, 2, 2], dims=[16, 32, 64, 128, 256],drop_path_rate=0., layer_scale_init_value=1e-6, out_indices=[0, 1, 2, 3, 4]):
        super().__init__()
        ...
        num_slices_small_list = [64, 32, 16, 8, 4]
        cur = 0
        for i in range(5):
            msc = MSC(dims[i])
...
class BraTSUMamba(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(BraTSUMamba, self).__init__()
    ...
    def forward_decoder(self,t1,t2,t3,t4,t5):
        ...
        B = t5.shape[0]
        # out, H, W, D = self.patch_embed3(t5)  # out:? N 256
        ...
        ### up stage
        # up1
        out = self.dbn1(self.decoder1(t5))
    ...
    def forward(self, source):
        ...
        out = self.forward_decoder(t1,t2,t3,t4,t5)
        x = out
        return x
