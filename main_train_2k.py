...
# from gmsm_4x_pc_fusion_RE import gmsm_4x_pc_fusion_RE
from unet import UNet3D, UNeXt3D_ablation
from unet.BraTS_UMamba import BraTSUMamba
...
# from train_model_2020_db import train_model
...
# from unet.gmsm_4x_adapt_pc import gmsm_4x_adapt
...
# from unet.UNeXt_3D_mlp_attention_seg_counting_mamba_4x_cbam_bsblock import UNeXt_3D_mlp_attention_pc_gmsm_fsca
from unet.UNeXt_3D_mlp_attention_gmsm_fd_fsca_pc import UNeXt_3D_mlp_attention_gmsm_fd_fsca_pc
# from unet.UNeXt_3D_counting_mamba_6x_sgfn import UNeXt_3D_counting_mamba_6x_sgfn
...
# from trisegmamba.segmamba import SegMamba
...
if __name__ == '__main__':
    ...
    if args.model_name=="UNeXt_3D_mlp_attention_pc_gmsm_fsca":
        model = UNeXt_3D_mlp_attention_pc_gmsm_fsca(n_channels=4, n_classes=4)
    ...
    # if args.model_name=="gmsm_4x_adapt":
    #     model = gmsm_4x_adapt(n_channels=4, n_classes=4)
    ...
    #     model = UNeXt_3D_mlp_attention_seg_counting_mamba_4x_cbam_bsblock(n_channels=4, n_classes=4)
    # if args.model_name=="UNeXt_3D_counting_mamba_6x_sgfn":
    #     model = UNeXt_3D_counting_mamba_6x_sgfn(n_channels=4, n_classes=4)
    ...
    if args.model_name == "s2ca_net":
        model = UNet_LGSM_MCA_MSADC_Plus(num_classes=4, input_channels=4, use_deconv=False, channels=(16, 32, 64, 128),
                                         strides=(1, 2, 2, 2), leaky=True, norm='INSTANCE').to(device)
