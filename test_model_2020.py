...
from dataset_builder import BrainDataset_BraTS2020, BrainDatasetTest_BraTS2020, RandomCrop_BraTS2020, TestToTensor_BraTS2020, ToTensor_BraTS2020
...
def test_model(model,
    ...
    #####################################################################
    # build test dataset
    test_dataset = BrainDatasetTest_BraTS2020(root_dir=test_data_dir,
                                    test_instance_id=test_instance_id,
                                    patch_size=args.patch_size,
                                    overlap_step=args.overlap_step,
                                    transform=transforms.Compose([
                                        TestToTensor_BraTS2020()
                                    ]))
